...
@section('title', 'Catalogo Tablas Antiguedad')
        ...
        <div class="card-content">
            ...
            <table id="tableGeneral" class="display responsive" width="100%" >
                ...
                <tbody>
                    ...
                    @foreach ($content['tablas_antiguedades'] as $tabla)

                        <tr>

                            <td>{{ $tabla->nombre }}</td>

                            <td>{{ $tabla->nombre_corto }}</td>
                            ...
                            <td class="center">
                                    ...
                                    <i href="{{route('tablas_antiguedades_edit',$tabla->tabla_antiguedad_id)}}"

                                        class="planner-text  material-icons tooltipped puntero editar-documento" data-delay="50"

                                            data-tooltip="Editar Tabla">edit
