...
@section('title', 'Catalogo Registros Patronales')
            ...
            <table id="tableGeneral" class="display responsive" width="100%" >
                ...
                <thead>
                    ...
                    <tr>
                        ...
                        <th data-priority="2">REGISTRO PATRONAL</th>

                        <th data-priority="3">ESTATUS</th>

                        <th data-priority="4">CLASE</th>
                ...
                <tbody>
                    ...
                    @foreach ($content['registros_patronales'] as $registro)
                        ...
                        <tr>
                            ...
                            <td class="center">
                                    ...
                                    <i href="{{route('registrospatronales_edit',$registro->registro_patronal_id)}}"
                            ...
                            <div class="row col s12">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col l4 m6 s12  input-field">
                                        ...
                                        <input type="text" name="registro_patronal" id="registro_patronal">
                                    ...
                                    <div class="col l4 m6 s12  input-field">
                                        ...
                                        <input type="text" name="clasificador_antiguedad" id="clasificador_antiguedad">
