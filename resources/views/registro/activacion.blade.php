        ...
        <div class="col s12">
            <div class="col l6 m8 s12 push-l3 push-m2">
                ...
                <div class="col s12 center">
                    <h3>CONFIRMA Y ACTIVA TU CUENTA</h3>
                </div>
                ...
                <div class="col s12 center">
                    <h4>Revisa tu Correo con la liga de Verificación</h4>
                        ...
                        <div class="row"></div>
                        <div class="col s12 center" >
                            <button class="btn waves-effect waves-light planners"><a class="white-text" href="{{route('ReenviarCorreo', $usuario_id)}}">Reenviar el Correo de Verificación</a></button>
