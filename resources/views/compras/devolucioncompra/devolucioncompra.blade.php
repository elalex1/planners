...
@section('title', 'Devoluciones de Compra')
				...
				<tr>
					...
					<td>
						...
						@case('Pendiente')
							...
							<i class="material-icons puntero docto-edit text-pending tooltipped" data-tooltip="Editar" href="{{ route('dev_compras_editar',$docto->docto_compra_id) }}" >edit</i>
						...
						@case('Terminado')
							...
							<i class="material-icons email-docto puntero text-finished tooltipped" data-tooltip="Enviar e-mail autorización" id-record="{{ $docto->docto_compra_id }}" prov-record="{{ $docto->proveedor }}">email</i>
						...
						@if($docto->estatus != 'Pendiente' && $docto->estatus != 'Cancelado' && $docto->estatus != 'Surtido' && $docto->ligadaf == 0)

                                    <i class="puntero material-icons tooltipped red-text cancelar-docto" with-modal="modal_cancelar" data-tooltip="Cancelar" campo_id_name="compra_id" id-record="{{ $docto->docto_compra_id }}">cancel</i>
						...
						<i class="material-icons visualizardocto tooltipped text-finished puntero" data-tooltip="Visualizar" href="{{route('dev_compras_visualizar',$docto->docto_compra_id)}}">remove_red_eye</i>
...
<div class="fixed-action-btn click-to-toggle">
	...
	<ul>
		...
		<li><a href="{{route('dev_compras_nueva')}}" class="btn-floating tooltipped blue" 

			data-position="left" data-tooltip="Nueva"><i class="material-icons">add_circle</i></a></li>

		<li><a disabled href="#verCompras" class="btn-floating tooltipped green modal-trigger"

			data-position="left" data-tooltip="Desde compras"><i class="material-icons">assignment</i></a></li>
...
<div class="modal modal-fixed-footer" id="verCompras">
    ...
    <div class="modal-content" >
        ...
        <table class="display tablamodal nowrap table-responsive" radio-record="1" id="tablaWithUrl" url-record="{{route('dev_compras_all_t')}}">
    ...
    <div class="modal-footer">
        ...
        <a href="{{ route('dev_compras_desde_compra') }}"
