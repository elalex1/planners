			...
			<div id="vista3" class="row col s12 bloque">
				<div class="row">
					<div class="input-field col s12">
							...
							@else
							<!-- Subir archivos -->
							<h6>Sin documentos asociados</h6>
							<input disabled type="file" accept=".pdf,image/*" name="archivo_docto" class="dropify" data-allowed-file-extensions="pdf png jpg jpeg" data-max-file-size="2.5M"/>
