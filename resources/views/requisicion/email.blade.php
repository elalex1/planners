                                                    ...
                                                    <td class="inner" style="padding-top:0px;padding-bottom:10px; padding-right:10px;padding-left:10px;"><table class="contents" style="border-spacing:0; width:100%" cellpadding="0" cellspacing="0" border="0">
                                                        ...
                                                        <tr>
                                                          <td  align="right" valign="top"><img src="https://gallery.mailchimp.com/fdcaf86ecc5056741eb5cbc18/images/392d9623-7a0f-47de-acdd-bf67d2a653c2.jpg" width="20" height="16" style="border-width:0; max-width:20px;height:auto; max-height:16px; padding-top:0px; padding-left:10px" alt=""/><font style="font-size:11px; text-decoration:none; color:#474b53; font-family: Verdana, Geneva, sans-serif; text-align:left; line-height:16px; padding-bottom:30px">
																													<a href="{{ route('sendemail', ['id' =>  $content['id_requisicion']]) }}" target="_blank" style="color:#474b53; text-decoration:none">Si no puedes ver correctamente este mensaje de clic aquí</a></font></td>
                                                        </tr>
                                                      </table></td>
                                                  </tr>
                                                </table>
                            ...
                            <td align="center"><table border="0" cellpadding="0" cellspacing="0" style="Margin:0 auto;">
                                <tr>
                                  <td width="250" height="60" align="center" bgcolor="#2f9780" style="-moz-border-radius: 30px; -webkit-border-radius: 30px; border-radius: 30px;">
																	<a id-record="{{$content['id_requisicion']}}" href="{{ route('autoriza', ['id' =>  $content['id_requisicion']]) }}" style="width:250; display:block; text-decoration:none; border:0; text-align:center; font-weight:bold;font-size:18px; font-family: Arial, sans-serif; color: #ffffff" class="button_link">Autorizar
